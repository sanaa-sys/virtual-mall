...
import { ArrowRight, CheckCircle, DollarSign, Package, Truck } from "lucide-react"
                    ...
                    <div className="container px-4 md:px-6">
                        ...
                        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="text-muted-foreground">Enjoy low selling fees and keep more of your profits.</p>
                            </div>
                            <div className="flex flex-col items-center text-center">
                                <Truck className="h-12 w-12 mb-4 text-primary" />
                                <h3 className="text-xl font-bold mb-2">Easy Shipping</h3>
                                <p className="text-muted-foreground">Access discounted shipping rates and convenient pickup options.</p>
                            </div>
                            <div className="flex flex-col items-center text-center">
                                <Package className="h-12 w-12 mb-4 text-primary" />
                                <h3 className="text-xl font-bold mb-2">Powerful Tools</h3>
                                <p className="text-muted-foreground">Manage your inventory, orders, and analytics with ease.</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container px-4 md:px-6">
                        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
                            <div className="flex flex-col justify-center space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <p className="max-w-[600px] text-muted-foreground md:text-xl">
                                        Join thousands of successful sellers on our platform. It's quick and easy to get started.
                                    </p>
                                </div>
                            ...
                            <div className="flex flex-col space-y-4 lg:p-8 lg:bg-background lg:rounded-lg">
                                <h3 className="text-xl font-bold">Get updates on seller news</h3>
