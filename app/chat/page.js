  ...
  return (
    <div className="grid h-screen w-full pl-[56px]">
      ...
      <div className="flex flex-col">
        ...
        <main className="grid flex-1 gap-4 overflow-auto p-4 md:grid-cols-2 lg:grid-cols-3 min-h-[92vh] max-h-[92vh]">
          <div
            ...
            <form className="grid w-full items-start gap-6">
              ...
              <fieldset className="grid gap-6 rounded-lg border p-4">
                ...
                <div className="grid gap-3">
                  ...
                  <Select defaultValue="system" readOnly>
                    <SelectTrigger>
          ...
          <div className="relative flex min-h-[40vh] flex-col rounded-xl bg-muted/50 p-4 lg:col-span-2">
            <Badge variant="outline" className="absolute right-3 top-3">
              Output
            </Badge>

            <ScrollArea className="h-[80%] w-full rounded-md p-3 mt-5 mb-2"></ScrollArea>
            <form
            ...
            >
              ...
              <Textarea
                ...
                className="min-h-12 resize-none border-0 p-3 shadow-none focus-visible:ring-0 focus:ring-0 focus:outline-none"
                value={message}
                onChange={(e) => setMeassge(e.target.value)}
              />
